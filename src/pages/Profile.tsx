      ...
      <div className="mx-auto max-w-3xl space-y-8">
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <form onSubmit={handleSave} className="space-y-4 rounded-xl border border-border bg-card p-6 shadow-card">
            <h2 className="text-lg font-semibold text-card-foreground">Personal Info</h2>
            ...
            <div className="space-y-2">
              <Label>Bio</Label>
              <Textarea value={form.bio} onChange={updateField('bio')} rows={3} placeholder="Tell us about yourself..." />
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-xl border border-border bg-card p-6 shadow-card">
              <h2 className="text-lg font-semibold text-card-foreground">Credits</h2>
              ...
              <p className="mt-2 text-sm text-muted-foreground">Each evaluation costs 1 credit</p>
            </div>
